...
UpdatePartyWIserouter.get('/show_update_party_wise_data/:Id', updatePartyWiseDataController.getDataByPartyId);
UpdatePartyWIserouter.patch('/edit_update_party_wise_data/:Id', updatePartyWiseDataController.updateDataByPartyId);
UpdatePartyWIserouter.delete('/delete_update_party_wise_data/:Id', updatePartyWiseDataController.deleteDataByPartyId);
